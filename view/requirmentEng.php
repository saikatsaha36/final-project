...
<table class="table table-primary">
    <tr class="table-warning">
        <th>What Language you prefer: </th>
        <th><select id="languages" class="languages" onchange="changeLanguage()">
    ...
    <tr >
        <th>Time:</th>
        <th> With in <input type="date" name="" id=""> </th>
    </tr>
    <tr class="table-warning" >
    </tr>
</table>
...
?>
<form action="../controller/progressing.php" method="post">
